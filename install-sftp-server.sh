...
echo "  DOMAIN=COCKPIT.YOUR-DOMAIN.COM                                                                                        " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
echo "#                                                                                                                       " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
...
echo "#                                                                                                                       " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
echo "# force a restart to pick up new certificate; this will interrupt existing sessions!                                    " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
echo "# if you don't do this, cockpit.service will idle-timeout a minute ,after the last session closed                       " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
echo "  sudo systemctl stop cockpit.service                                                                                   " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
echo "#                                                                                                                       " | sudo tee -a /etc/letsencrypt/deploy/update_cockpit_certificate.sh
